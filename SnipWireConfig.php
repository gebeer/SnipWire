...
class SnipWireConfig extends ModuleConfig
{
    ...
    public function getInputfields()
    {
        ...
        /** @var InputfieldCheckbox $f */
        $f = $modules->get('InputfieldCheckbox');
        $f->attr('name', 'local_dev');
        $f->label = $this->_('Local Development Mode');
        $f->label2 = $this->_('Enable local development mode');
        $f->description = $this->_('When enabled, certain features may be adjusted for local development environments.');
        $f->columnWidth = 100;
